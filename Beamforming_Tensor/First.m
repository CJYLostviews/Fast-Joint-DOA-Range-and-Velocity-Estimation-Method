...
DataFile.dataFolderName='G:\Tensor_for_FMCW_MIMO_Ti\Paper_Indoor\adc_data_0909_01\';
fileName=DataFile;
...
[eA,eV,eR] = comfac(Y,K); 
eDOA_PARAFAC	=	PHase_DOA(eA,[0:M-1])
eVelocity_PARAFAC	=	PHase_Velocity(eV,[1:nchirp_loops]*(Tpr/lamda))
eRange_PARAFAC	=	PHase_Range(eR,eVelocity_PARAFAC,lamda,speedOfLight,chirpSlope,[1:numADCSample]*adcSampleTime)
